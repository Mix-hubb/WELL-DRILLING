-- ============================================================
-- เธฃเธฐเธเธเธเธฑเธ”เธเธฒเธฃเธเนเธญเธเธฒเธ”เธฒเธฅเธ”เธดเธเธดเธ—เธฑเธฅ (Supabase / PostgreSQL) โ€” Schema v2 + ALTER
-- เธฃเธฑเธเนเธ Supabase SQL Editor เธ—เธตเน€เธ”เธตเธขเธง
-- ============================================================
...
-- ============================================================
-- USERS: เธเธนเนเธเธฃเธฐเธเธญเธเธเธฒเธฃ (login)
-- ============================================================
...
create table public.users (
  ...
  reset_method     text check (reset_method in ('email', 'sms')),
...
-- ============================================================
-- CORE: customers โ€” เธฅเธนเธเธเนเธฒ
-- ============================================================
...
-- ============================================================
-- CORE: wells โ€” เธเนเธญเธเธฒเธ”เธฒเธฅ
-- ============================================================
...
create table public.wells (
  ...
  well_name              text not null default 'เธเนเธญเธซเธฅเธฑเธ',
  address                text,
